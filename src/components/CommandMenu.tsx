...
<dyad-write path="src/components/CommandMenu.tsx" description="Integrando o Menu de Comando com a base de conhecimento real para buscas instantâneas via Ctrl+K.">
"use client";
